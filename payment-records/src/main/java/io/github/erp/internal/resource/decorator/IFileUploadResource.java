...
public interface IFileUploadResource {
     ...
     */
    ResponseEntity<PaymentsFileUploadDTO> createFileUpload(@Valid @RequestBody PaymentsFileUploadDTO fileUploadDTO) throws URISyntaxException;
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ResponseEntity<PaymentsFileUploadDTO> updateFileUpload(@Valid @RequestBody PaymentsFileUploadDTO fileUploadDTO) throws URISyntaxException;
     ...
     */
    ResponseEntity<List<PaymentsFileUploadDTO>> getAllFileUploads(PaymentsFileUploadCriteria criteria, Pageable pageable);
     ...
     */
    ResponseEntity<Long> countFileUploads(PaymentsFileUploadCriteria criteria);
     ...
     */
    ResponseEntity<PaymentsFileUploadDTO> getFileUpload(@PathVariable Long id);
