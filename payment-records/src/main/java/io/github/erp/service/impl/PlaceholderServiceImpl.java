...
public class PlaceholderServiceImpl implements PlaceholderService {
    ...
    public PlaceholderServiceImpl(PlaceholderRepository placeholderRepository, PlaceholderMapper placeholderMapper, PlaceholderSearchRepository placeholderSearchRepository) {
    ...
    public Page<PlaceholderDTO> findAll(Pageable pageable) {
        ...
        return placeholderRepository.findAll(pageable)
    ...
    public Page<PlaceholderDTO> search(String query, Pageable pageable) {
        ...
        return placeholderSearchRepository.search(queryStringQuery(query), pageable)
            .map(placeholderMapper::toDto);
    }
}
