...
@RestController
@RequestMapping("/api/payment-records-kafka")
public class PaymentRecordsKafkaResource {

    private final Logger log = LoggerFactory.getLogger(PaymentRecordsKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public PaymentRecordsKafkaResource(KafkaProperties kafkaProperties) {
