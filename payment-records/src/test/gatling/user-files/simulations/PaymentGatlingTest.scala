...
class PaymentGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Payment entity")
        ...
        .repeat(2) {
            ...
            .get("/services/paymentrecords/api/payments")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new payment")
            .post("/services/paymentrecords/api/payments")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "paymentsCategory":"SAMPLE_TEXT"
                , "transactionNumber":"SAMPLE_TEXT"
                , "transactionDate":"2020-01-01T00:00:00.000Z"
                , "transactionCurrency":"SAMPLE_TEXT"
                , "transactionAmount":"0"
            ...
            .repeat(5) {
                ...
                .get("/services/paymentrecords${new_payment_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created payment")
            .delete("/services/paymentrecords${new_payment_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
