...
To build the final jar and optimize the paymentRecordsGate application for production, run:
...
Then navigate to [http://localhost:8791](http://localhost:8791) in your browser.
