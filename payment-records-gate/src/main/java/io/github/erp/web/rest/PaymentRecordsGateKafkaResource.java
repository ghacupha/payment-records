...
@RestController
@RequestMapping("/api/payment-records-gate-kafka")
public class PaymentRecordsGateKafkaResource {

    private final Logger log = LoggerFactory.getLogger(PaymentRecordsGateKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public PaymentRecordsGateKafkaResource(KafkaProperties kafkaProperties) {
